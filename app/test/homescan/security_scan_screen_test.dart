...
void main() {
  ...
  // The specialist CTA now opens the support-request flow (navigation), which
  // replaced #81's email/clipboard stopgap — covered end-to-end in
  // support/support_request_screen_test.dart and the app E2E.
