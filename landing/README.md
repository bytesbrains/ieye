...
(#43): Google sign-in, a user account, and an admin shell, built on top of the CISO's
...
├─ firestore.rules          # CISO security boundary (the real authz)
...
├─ firestore-tests/         # CISO emulator-backed rules tests
└─ src/
...
## CISO constraints honored (THREAT-MODEL §7)
